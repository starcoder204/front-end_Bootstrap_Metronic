...
jQuery(document).ready(function() {
    $("#submit_button").click(function() {
        ...
        if (!credit_code && !registration_number && !company_name) {
            console.log("Provide one of 3 fields");
        } else {
            localStorage.setItem('necessary_data', JSON.stringify(necessary_data));
            location.href = '/components/widgets/lists.html';
        }
    });
    KTDashboard.init();
});
